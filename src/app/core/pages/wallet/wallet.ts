...
export class WalletPage implements OnInit {
  ...
  updateData = async (data: Partial<Database['public']['Tables']['WALLET']['Update']>) => {
    const response = await this.dynamicService.updateData('WALLET', data, {
      field: 'wallet_id',
      value: this.id()!,
    });
    return response;
  ...
  deleteData = async (rowId: string) => {
    ...
    const response = await this.dynamicService.deleteData('WALLET', {
      field: 'wallet_id',
      value: rowId,
    });
